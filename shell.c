...
int wordEnding(char c) {
    // may want to add ';' to this at some point or find a different way to implement chains.
    return c == '\0' || c == '\n' || isspace(c) || c == ';';
}
...
int parseInput(const char inp[]) {
    ...
    // if  really wanted to implement relatively complex
    ...
    // parser rather than just a tokenizer. So we'll handle it here. TODO: could update later
